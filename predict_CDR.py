# ### predict_CDR.py
# ### Script to load the OSHA-trained hurdle model and make predictions for the CDR dataset
# ### Version date 4/22 - for internal review
...
plt.savefig('output/figures/fig6_with_extrapolation.png')
plt.close()

fig6_path = 'output/figures/fig6.png'
